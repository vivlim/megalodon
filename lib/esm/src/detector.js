...
export var detector = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                return [4, axios.get(url + '/.well-known/nodeinfo', options)];
            case 1:
                res = _e.sent();
                ...
                return [3, 8];
            case 2: return [4, axios.get(link.href, options)];
            case 3:
                res_1 = _e.sent();
                ...
                _e.label = 4;
            case 4: return [4, axios.get(link.href, options)];
            case 5:
                res_2 = _e.sent();
                ...
                _e.label = 6;
            case 6: return [4, axios.get(link.href, options)];
            case 7:
                res_3 = _e.sent();
                ...
                _e.label = 8;
            case 8: throw new NodeinfoError('Could not find nodeinfo');
        }
    });
}); };
