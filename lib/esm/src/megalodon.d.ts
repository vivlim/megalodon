...
declare const generator: (sns: 'mastodon' | 'pleroma' | 'friendica' | 'firefish' | 'gotosocial', baseUrl: string, accessToken?: string | null, userAgent?: string | null) => MegalodonInterface;
