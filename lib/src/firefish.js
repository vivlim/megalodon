...
var FirefishOAuth = __importStar(require("./firefish/oauth"));
...
var Firefish = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, new Promise(function (_, reject) {
                        var err = new megalodon_1.NotImplementedError('Firefish does not support this method');
                        reject(err);
                    })];
            });
        });
                        ...
                        return __generator(this, function (_h) {
                            switch (_h.label) {
                                case 0:
                                    ...
                                    _c = [res];
                                    _g = {};
                                    _e = (_d = api_client_1.default.Converter).userPreferences;
                                    _f = [res.data];
            ...
            return __generator(this, function (_a) {
                return [2, this.client
                        ...
                        if (!res.data || (res.data != 'public' && res.data != 'home' && res.data != 'followers' && res.data != 'specified'))
                            return 'public';
                        return api_client_1.default.Converter.visibility(res.data);
                    })
    ...
    Firefish.prototype.readNotifications = function (_options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, new Promise(function (_, reject) {
                        var err = new megalodon_1.NotImplementedError('mastodon does not support');
                        reject(err);
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 12: return [2, {
                            data: {
                                accounts: accounts.map(function (a) { return api_client_1.default.Converter.userDetail(a); }),
                                statuses: statuses.map(function (n) { return api_client_1.default.Converter.note(n); }),
    ...
    Firefish.prototype.getInstance = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client
                        .get('/api/v1/instance')
                        .then(function (res) { return (__assign(__assign({}, res), { data: api_client_1.default.Converter.instance(res.data) })); })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client
                        ...
                        .then(function (res) { return (__assign(__assign({}, res), { data: res.data.map(function (a) { return api_client_1.default.Converter.announcement(a); }) })); })];
            });
        });
    };
    ...
    Firefish.prototype.tagStreaming = function (_tag) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new megalodon_1.NotImplementedError('TODO: implement');
            });
        });
    };
