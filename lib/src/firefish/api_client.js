...
var notification_2 = __importStar(require("../notification"));
var FirefishAPI;
(function (FirefishAPI) {
    ...
    (function (Converter) {
        ...
        Converter.encodeNotificationType = function (e) {
            switch (e) {
                ...
                case notification_2.default.Reaction:
                ...
                default:
                    return new notification_2.UnknownNotificationTypeError();
            }
        };
        Converter.decodeNotificationType = function (e) {
            switch (e) {
                ...
                case notification_1.default.Reaction:
                    return notification_2.default.Reaction;
        ...
        Converter.notification = function (n) {
            ...
            if (notificationType instanceof notification_2.UnknownNotificationTypeError) {
    ...
    var Client = (function () {
        ...
        Client.prototype.socket = function (url, channel, listId) {
            ...
            var streaming = new web_socket_1.default(url, channel, this.accessToken, listId, this.userAgent);
            streaming.start();
            return streaming;
        };
        return Client;
