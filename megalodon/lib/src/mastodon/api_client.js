    ...
    (function (Converter) {
        Converter.encodeNotificationType = function (t) {
            switch (t) {
                ...
                case notification_1.default.AdminSignup:
                    return notification_2.default.AdminSignup;
                case notification_1.default.AdminReport:
                    return notification_2.default.AdminReport;
                default:
        ...
        Converter.decodeNotificationType = function (t) {
            switch (t) {
                ...
                case notification_2.default.AdminSignup:
                    return notification_1.default.AdminSignup;
                case notification_2.default.AdminReport:
                    return notification_1.default.AdminReport;
                default:
                    return new notification_1.UnknownNotificationTypeError();
            }
        };
