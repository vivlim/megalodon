...
var Gotosocial = (function () {
    ...
    Gotosocial.prototype.verifyAppCredentials = function () {
        return new Promise(function (_, reject) {
            var err = new NotImplementedError('Gotosocial does not support this method');
            reject(err);
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/statuses"), params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (s) { return GotosocialAPI.Converter.status(s); })
                        });
                    })];
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        converted = Object.assign({}, res, {
                            data: res.data.map(function (a) { return GotosocialAPI.Converter.account(a); })
                        });
                    ...
                    case 3:
                        ...
                        converted = Object.assign({}, converted, {
                            data: __spreadArray(__spreadArray([], __read(converted.data), false), __read(nextRes.data.map(function (a) { return GotosocialAPI.Converter.account(a); })), false)
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/lists")).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (l) { return GotosocialAPI.Converter.list(l); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client
                        ...
                        .then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (r) { return GotosocialAPI.Converter.relationship(r); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/filters').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (f) { return GotosocialAPI.Converter.filter(f); })
                        });
                    })];
            });
        });
            ...
            return __generator(this, function (_a) {
                ...
                if (options) {
                    ...
                    if (options.exclude_types) {
                        params = Object.assign(params, {
                            exclude_types: options.exclude_types.map(function (e) { return GotosocialAPI.Converter.encodeNotificationType(e); })
                        });
                    }
                ...
                return [2, this.client.get('/api/v1/notifications', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.flatMap(function (n) {
                                var notify = GotosocialAPI.Converter.notification(n);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        notify = GotosocialAPI.Converter.notification(res.data);
                        if (notify instanceof UnknownNotificationTypeError) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/custom_emojis').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (e) { return GotosocialAPI.Converter.emoji(e); })
                        });
                    })];
            });
        });
