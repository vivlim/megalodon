        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, new Promise(function (_, reject) {
                        var err = new NotImplementedError('Friendica does not support this method');
                        reject(err);
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/statuses"), params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (s) { return FriendicaAPI.Converter.status(s); })
                        });
                    })];
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        converted = Object.assign({}, res, {
                            data: res.data.map(function (a) { return FriendicaAPI.Converter.account(a); })
                        });
                    ...
                    case 3:
                        ...
                        converted = Object.assign({}, converted, {
                            data: __spreadArray(__spreadArray([], __read(converted.data), false), __read(nextRes.data.map(function (a) { return FriendicaAPI.Converter.account(a); })), false)
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/lists")).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (l) { return FriendicaAPI.Converter.list(l); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/identity_proofs")).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (i) { return FriendicaAPI.Converter.identity_proof(i); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client
                        ...
                        .then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (r) { return FriendicaAPI.Converter.relationship(r); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/filters').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (f) { return FriendicaAPI.Converter.filter(f); })
                        });
                    })];
            });
        });
            ...
            return __generator(this, function (_a) {
                if (limit) {
                    return [2, this.client
                            ...
                            .then(function (res) {
                            return Object.assign(res, {
                                data: res.data.map(function (a) { return FriendicaAPI.Converter.follow_request(a); })
                            });
                        })];
                }
                else {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get('/api/v1/scheduled_statuses', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (s) { return FriendicaAPI.Converter.scheduled_status(s); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get('/api/v1/conversations', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (c) { return FriendicaAPI.Converter.conversation(c); })
                        });
                    })];
            });
        });
            ...
            return __generator(this, function (_a) {
                ...
                if (options) {
                    ...
                    if (options.exclude_types) {
                        params = Object.assign(params, {
                            exclude_types: options.exclude_types.map(function (e) { return FriendicaAPI.Converter.encodeNotificationType(e); })
                        });
                    }
                ...
                return [2, this.client.get('/api/v1/notifications', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.flatMap(function (n) {
                                var notify = FriendicaAPI.Converter.notification(n);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        notify = FriendicaAPI.Converter.notification(res.data);
                        if (notify instanceof UnknownNotificationTypeError) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/instance/activity').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (a) { return FriendicaAPI.Converter.activity(a); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get('/api/v1/trends', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (t) { return FriendicaAPI.Converter.tag(t); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/custom_emojis').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (e) { return FriendicaAPI.Converter.emoji(e); })
                        });
                    })];
            });
        });
