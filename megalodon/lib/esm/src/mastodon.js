...
import { NotImplementedError } from './megalodon';
...
var Mastodon = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/statuses"), params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (s) { return MastodonAPI.Converter.status(s); })
                        });
                    })];
            });
        });
    ...
    Mastodon.prototype.getAccountFavourites = function (_id, _options) {
        return new Promise(function (_, reject) {
            var err = new NotImplementedError('Mastodon does not support this method');
            reject(err);
        });
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        converted = Object.assign({}, res, {
                            data: res.data.map(function (a) { return MastodonAPI.Converter.account(a); })
                        });
                        if (!(get_all && converted.headers.link)) return [3, 6];
                        parsed = parseLinkHeader(converted.headers.link);
                        _a.label = 2;
                    case 2:
                    ...
                    case 3:
                        ...
                        converted = Object.assign({}, converted, {
                            data: __spreadArray(__spreadArray([], __read(converted.data), false), __read(nextRes.data.map(function (a) { return MastodonAPI.Converter.account(a); })), false)
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/lists")).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (l) { return MastodonAPI.Converter.list(l); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/identity_proofs")).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (i) { return MastodonAPI.Converter.identity_proof(i); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client
                        ...
                        .then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (r) { return MastodonAPI.Converter.relationship(r); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/filters').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (f) { return MastodonAPI.Converter.filter(f); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/featured_tags').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (f) { return MastodonAPI.Converter.featured_tag(f); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/featured_tags/suggestions').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (t) { return MastodonAPI.Converter.tag(t); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/followed_tags').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (tag) { return MastodonAPI.Converter.tag(tag); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get('/api/v1/scheduled_statuses', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (s) { return MastodonAPI.Converter.scheduled_status(s); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get('/api/v1/conversations', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (c) { return MastodonAPI.Converter.conversation(c); })
                        });
                    })];
            });
        });
            ...
            return __generator(this, function (_a) {
                ...
                if (options) {
                    ...
                    if (options.exclude_types) {
                        params = Object.assign(params, {
                            exclude_types: options.exclude_types.map(function (e) { return MastodonAPI.Converter.encodeNotificationType(e); })
                        });
                    }
                ...
                return [2, this.client.get('/api/v1/notifications', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.flatMap(function (n) {
                                var notify = MastodonAPI.Converter.notification(n);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        notify = MastodonAPI.Converter.notification(res.data);
                        if (notify instanceof UnknownNotificationTypeError) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/instance/activity').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (a) { return MastodonAPI.Converter.activity(a); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/custom_emojis').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (e) { return MastodonAPI.Converter.emoji(e); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/announcements').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (a) { return MastodonAPI.Converter.announcement(a); })
                        });
                    })];
            });
        });
